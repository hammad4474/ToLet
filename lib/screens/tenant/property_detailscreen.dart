    ...
    return Scaffold(
      ...
      appBar:AppBar(
        leading: Container(
          ...
          child: IconButton(
            icon: Icon(Icons.arrow_back, color: Colors.white, size: 18), // Black back icon
            onPressed: () {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Container(
                          width: MediaQuery.of(context).size.width * 0.9, // 90% of the screen width for padding on the sides
                          padding: EdgeInsets.all(3), // Padding for the bold gradient border
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(50), // Cylinder shape with bold blue border
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: Colors.white, // White background inside the border
                              borderRadius: BorderRadius.circular(50), // Keep the inner container cylindrical
                            ),
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Colors.white, // Button background should be white
                                shadowColor: Colors.transparent, // Remove button shadow
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(50), // Cylindrical shape
                                ),
                          ...
                          Row(
                            children: [
                              Image.asset(
                                ...
                                width: 24, // Set width of the image (adjust as needed)
                                height: 24, // Set height of the image
                              ),
                              SizedBox(width: 8), // Space between icon and text
                              Text('2 Room', style: TextStyle(fontSize: 16)), // Text next to the image
                            ],
                          ),
                        ],
                      ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 8),
                              Text('874 m²', style: TextStyle(fontSize: 16)), // Text next to the image
                            ],
                          ),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            decoration: BoxDecoration(
                              color: Colors.white, // Background color (you can customize)
                              shape: BoxShape.rectangle, // Ensures the container is a square
                            ...
                            width: 40, // Define the width and height to create a square shape
                            height: 40,
                            child: IconButton(
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.start, // Aligns the columns at the start of the row
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start, // Aligns text to the left inside the column
                    children: [
                      Text(
                        '₹10,000 / month',
                        style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                      ),
                      SizedBox(height: 4), // Small space between rent and payment estimation
                      Text(
                        'Payment estimation',
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(30), // Make it fully rounded (cylindrical)
                    ),
                    child: ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.transparent, // Button background transparent to show gradient
                        shadowColor: Colors.transparent, // Remove default shadow
                        padding: EdgeInsets.symmetric(horizontal: 45, vertical: 20), // Adjust padding
                        shape: RoundedRectangleBorder(
